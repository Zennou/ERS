...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body onload="init()">  
	...
	<div align="center">
		<div id="centeredmenu">
			<ul class="tab">
				<li><a href="#" class="tablinks" onclick="openCity(event, 'All')">All</a></li>
				<li><a href="#" class="tablinks" onclick="openCity(event, 'Resolved')">Resolved</a></li>
				<li><a href="#" class="tablinks" onclick="openCity(event, 'By Name')">By User Name</a></li>
			</ul>
		</div>

		<div class="tabcontent" id="all" style="width:70%;">
		...
		<div class="tabcontent" id="resolved" style="width:70%;">
		...
		<div class="tabcontent" id="byname" style="width:70%;">
